...
Before opening a fresh issue, do a search on [the wiki](http://robots.uc3m.es/) and on [GitHub](https://github.com/roboticslab-uc3m/amor-openrave-models/issues?utf8=%E2%9C%93&q=is%3Aissue) and make sure it hasn't already been addressed. Here are some notes on how to detail feature requests or bug reports:

3D OpenRAVE models for [AMOR](http://www.amorrobot.com/) robot. If you are looking for the source code of the robot itself, visit the [amor-api](https://github.com/roboticslab-uc3m/amor-api) repository (private).
